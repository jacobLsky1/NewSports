...
class StandingsAdapter1(
    private val countries: ArrayList<Standing>,
    private val context: Context,
    private val teamAId: Long,
    private val teamBId: Long
) : ExpandableRecyclerAdapter<Standing, TeamStanding, StandingsAdapter1.LeagueStandingHeadingHolder, StandingsAdapter1.TeamStandingViewHolder>(
    countries
) {
